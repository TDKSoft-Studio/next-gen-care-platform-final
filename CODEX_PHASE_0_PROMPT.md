...
Read both completely before acting.
...
Do not assume that the current repository contains all required repositories.
...
- Git status and recent history where safe;
- package manifests;
- lockfiles;
...
Evaluate the 31 August 2026 release target against actual evidence.

Do NOT say it is feasible merely because the date is in the contract.

...
| `docs/application-deployment-contract.md`         | the authoritative application deployment contract                           | contract consumed by the deployment repository               |
| `docs/contracts/application-profile.example.yaml` | machine-readable example profile mirroring the contract                     | non-secret, non-deployable contract input for the infra repo |
